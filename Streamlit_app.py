...
with tab2:
    ...
    if st.button("🔍 Scout & Auto-Calculate"):
        with st.status("Sifting 2026 news..."):
            ...
            prompt = f"March 15, 2026. Lead: {co_name}. Count: {found_count}. Risk: ${total_debt:,}. News: {news_text}. Draft Specialist Pitch for CO AI Act deadline June 30."
    ...
    if st.session_state.scout_report:
        ...
        # BYTES FIX: Ensuring data is bytes for download
